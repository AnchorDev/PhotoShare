...
export function Search ({navigation}) {
  ...
  useEffect(() => {
    const localImages = [
      { name: '@eliza', path: Asset.fromModule(require('./assets/1.jpg')).uri },
      { name: '@karol', path: Asset.fromModule(require('./assets/2.jpg')).uri },
      { name: '@kuba', path: Asset.fromModule(require('./assets/3.jpg')).uri },
      { name: '@radek', path: Asset.fromModule(require('./assets/4.jpg')).uri },
      { name: '@julia', path: Asset.fromModule(require('./assets/5.jpg')).uri }
    ];
